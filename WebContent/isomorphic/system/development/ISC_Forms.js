...
,isc.A.isReadOnly=function isc_FormItem_isReadOnly(){var _1=this.form;var _2=(_1&&_1.canEditFieldAttribute)||"canEdit";var _3=this;while(_3.parentItem){if(_3[_2]!=null)return!_3[_2];_3=_3.parentItem}
return!isc.DynamicForm.canEditField(_3,_1)}
...
);isc.evalBoundary;isc.B.push(isc.A.setTabIndex=function isc_FormItem_setTabIndex(_1){this.globalTabIndex=null;this.tabIndex=_1;this.$173(_1)}
...
);isc.B._maxIndex=isc.C+3;isc.ClassFactory.defineClass("LinkItem","TextItem");isc.A=isc.LinkItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.wrap=false;isc.A.canEdit=false;isc.A.readOnlyTextBoxStyle="staticTextItem";isc.B.push(isc.A.shouldApplyStaticTypeFormat=function isc_LinkItem_shouldApplyStaticTypeFormat(){return!this.canEdit}
